      ...
      <div className="max-w-2xl mx-auto">
        ...
        >
          ...
          <p className="text-slate-500 dark:text-slate-400 leading-relaxed max-w-md mx-auto mb-8">
            I'm currently an undergraduate at SLIIT actively seeking internship opportunities.
            This section will be updated as I gain professional experience in the industry.
          </p>
